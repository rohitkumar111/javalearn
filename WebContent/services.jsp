 ...
 <section class="mid_part" id="mid_section">   <!-- row -->
		...
		<!-- <div class="tutorial-heading"><p class="tutorial-text-size">Tutorials</p></div>          col-xs-4 col-md-2-->	
			<div class="main-tut-list">
				<div class="tutorial-point">Learn Core Java</div>
				<a href="#" class="tutorial">Intro of Java</a>
				<a href="#" class="tutorial">History of Java</a>
		...
		<!-- 	<button  onclick="document.getElementById('side-bar-id').style.display='block'" type="button" data-toggle="collapse" 
		 ...
		 <div id="myNavbar">   
			...
			<h2 class="topic-heading">INTRODUCTION OF JAVA</h2>
			<p class="topic-intro">
			...
			<div class="fully-topic-intro">
				<p class="content-style">In this tutorial, you have been learn the following concepts</p>
			...
			<hr>
			<h4 class="sub-topic-heading">Object-Oriented Programming Concepts</h4>
			<div class="topic-content">
			<p class="content-style">The object-oriented technique is based on basic three concepts.They are:</p>
				<ul class="types">
					<li class="types-part">Data encapsulation</li>
					<li class="types-part">Inheritance</li>
					<li class="types-part">Polymorphism</li>
				</ul>
			<h5 class="defination">1. Data encapsulation</h5>
			...
			<h5 class="defination">2. Inheritance</h5>
			...
			<h5 class="defination">3. Polymorphism</h5>
			...
			<h4 class="sub-topic-heading">Types of Java Programs</h4>
			...
			<h5 class="defination">Multithreaded</h5>
			...
			<h5 class="defination">Architecture Neutral</h5>
			...
			<h5 class="defination">Internet Ready</h5>
			...
			<h5 class="defination">Application Program</h5>
			<p>Java can be used for writing programs that Run in a PC under the control of the operating system in that machine. such programs 
			   are termed as application programs.</p>
			<h5 class="defination">Applet</h5>
			<p>Programs can be written and compiled to give what is called bytecodes. These bytecodes can be downloaded mostly from a remote server
			   and executed without any control from the local operating system. Such programs are called applet.</p><hr>
			
			<h4 class="sub-topic-heading">Java Architecture</h4>
			<p>Java programming environment is based on the following four technologies:</p>
			<ul class="types">
			...
			<p>Java source program is created using the feature of Java language. The source program is then compiled using the Java compiler, javac,
		    ...
		    <p class="Example">example:- Java Architecture</p>
			<div class="flow-chart">
				<img class="java-img all-img" alt="" src="assets/images/java-architecture.png">
			</div>
		    <hr>
			
			<h4 class="sub-topic-heading">Platform Independent</h4>
			<p>The Java Platform is different for different machines. Java Platform for UNIX, Windows, Macintosh, etc. are different from one another
			...
			<p class="Example">example:- Platform-Independent Java Program</p>
			<div class="flow-chart">
