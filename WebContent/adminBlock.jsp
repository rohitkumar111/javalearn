 ...
 <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" name="done">Submit</button>
		...
		<hr>
		<h3>Find User Detail</h3><a href="sud.jsp?find=all">All User Detail</a>
		<form method="post" action="sud.jsp?find=sub">
		 <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">UserName</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="password" name="username">
    </div>
  </div>
