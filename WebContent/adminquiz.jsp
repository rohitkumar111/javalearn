...
<%@ include file="assets/pages/header/adminHeader.html" %>
 ...
 <section class="mid_part" id="mid_section">   <!-- row -->
		...
		<div class="action-fld"> 	
			...
			<form class="form-horizontal" method="post" action="addData.jsp?tutorial=<%= request.getParameter("tutorial") %>">
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
    <textarea class="form-control" id="inputEmail3" placeholder="Question.." col=20 row=4 name="que"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Answer(a)</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Answer" name="ans1">
    </div>
  </div>
   <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Answer(b)</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Answer" name="ans2">
    </div>
  </div>
   <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Answer(c)</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Answer" name="ans3">
    </div>
  </div>
   <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Answer(d)</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Answer" name="ans4">
    </div>
  </div>
   <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Answer(True)</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="True Answer" name="true_ans">
    </div>
  </div>
...
<%
String tutorial=(String)request.getParameter("tutorial");
List<Quiz> list=QuizDao.getAllRecords(tutorial);
request.setAttribute("list",list);
%>
<table class="table">
  <tr><th>#</th><th>Question</th><th>Edit</th><th>Delete</th></tr>
  <c:forEach items="${list}" var="q">
  <tr><td>${q.getId()}</td><td>${q.getQue()}</td><td><a href="updateform.jsp?id=${q.getId()}&&tutorial=<%= request.getParameter("tutorial") %>">edit</a></td><td><a href="deleteData.jsp?id=${q.getId()}&&tutorial=<%= request.getParameter("tutorial") %>">delete</a></td></tr>
  </c:forEach>
